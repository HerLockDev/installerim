...
REPO_URL = "https://github.com/HerLockDev/NitroUserBot"
LANG = LANG['MAIN']
...
if __name__ == "__main__":
    ...
    if os.path.isdir("./nitrouserbot/"):
        rm_r("./nitrouserbot/")
    repo = Repo.clone_from(REPO_URL,"./nitrouserbot/", branch="master")
    ...
    config['DEFAULT_BIO'] = "@NitroUserBot"
    ...
    config['TZ'] = TZ
    config['TZ_NUMBER'] = "1"
    config['UPSTREAM_REPO_URL'] = "https://github.com/HerlockDev/nitrouserbot"
    config['WARN_LIMIT'] = "3"
    ...
    if Sonra == True:
        ...
        basarili("Tezliklə görüşərik! Ciğer")
